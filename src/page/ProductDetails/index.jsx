  ...
  return (
    <Box>
      ...
      {isLoading ? (
        ...
        <Grid container key={data?.id} sx={{ display: "flex", justifyContent: "center", marginTop: '20px' }}>
          ...
          <Grid item xs={12} sm={8} md={6} lg={4} xl={2} sx={{ px: 2 }}>
            <Box sx={{ display: "flex", height: "400px", flexDirection: "column", justifyContent: "center" }}>
              ...
              <Typography variant="overline">Category: {data.category}</Typography>
              ...
              <Span style={{ marginTop: 15 }}>₹ {data.price}</Span>
              <Button
                sx={{ mt: 3 }}
                color="success"
                variant='contained'
              ...
              >
                {isHover ? <AddShoppingCartIcon /> : "Add to Cart"}
              </Button>
            </Box>
          </Grid>
        </Grid>
